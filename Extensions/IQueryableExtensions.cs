...
namespace LubricantsServiceBackend.Extensions
{
    public static class IQueryableExtensions
    {
        ...
        public static List<TEntity> Paginate<TEntity>(this List<TEntity> list, LubricantsServiceBackend.DTOs.Range range)
        {
