...
using LubricantsServiceBackend.Extensions;
...
namespace LubricantsServiceBackend.Services
{
    public class UsersServices : ControllerBase
    {
        ...
        private async Task<AuthResponseDTO> BuildToken(ApplicationUser user)
        {
            ...
            var key = new SymmetricSecurityKey(Encoding.UTF8.GetBytes(Environment.GetEnvironmentVariable("LUBRICANTS_JWT_KEY")));
